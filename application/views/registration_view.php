    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">SongUniverse</a>
            </div>
...
<br>
<p>Oops! Looks like you are not logged in yet, you need to log in to view this page, if you don't have an account you can simply create one below, its simple and fast. Enter your details and you are ready to go.</p>
<div class="reg_form">
<div class="form_title">Sign up for a Customer Account</div>
...
<?php echo validation_errors('<p class="error">'); ?>
	<?php echo form_open("welcome/registration"); ?>
		...
		<p>
			<label for="confirm_email_address">Confirm your Email Address:</label>
			<input type="text" id="confirm_email_address" name="confirm_email_address" value="<?php echo set_value('confirm_email_address'); ?>" /><span id="confirm_email_verify" class="verify"></span>
		</p>
		<p>
		...
		<p>
			...
			<input type="text" id="address" name="address" value="<?php echo set_value('address'); ?>" /><span id="address_verify" class="verify"></span>
		</p>
		<p>
			<label for="city">City:</label>
			<input type="text" id="city" name="city" value="<?php echo set_value('city'); ?>" /><span id="city_verify" class="verify"></span>
		</p>
		<p>
			<label for="postcode">Your Postcode:</label>
			<input type="text" id="postcode" name="postcode" value="<?php echo set_value('postcode'); ?>" /><span id="postcode_verify" class="verify"></span>
		</p>
		<p>
